      ...
      $html='
        <table cellspacing="" cellpadding="3">
          <tr bgcolor="#ffffff">
            ...
            <td width="25%" align="center"rowspan="6"><img src="'.base_url('/assets/img/pgw_images/'.$row->img_lmr).'" width="110" height="120"></td>
          </tr>
          <tr bgcolor="#ffffff">
            <td width="50%" align="center"></td>
          </tr>
        ...
        <table cellspacing="" cellpadding="3">
          ...
          <tr bgcolor="#ffffff">
            ...
            <td width="5%" align="center">:</td>
            <td width="70%" align="left">'.$row->nama_lmr.'</td>  
          </tr>
          <tr bgcolor="#ffffff">
            <td width="25%" align="left">No. KTP</td>
            <td width="5%" align="center">:</td>
            <td width="70%" align="left">'.$row->no_ktp_lmr.'</td>  
          </tr>
          <tr bgcolor="#ffffff">
          ...
          <tr bgcolor="#ffffff">
            ...
            <td width="5%" align="center">:</td>
            <td width="70%" align="left">'.$row->tmp_lahir_lmr.'</td> 
          </tr>
          <tr bgcolor="#ffffff">
            <td width="30%" colspan="2"></td>
            <td width="70%" align="left">'.$row->tgl_lahir_lmr.'</td> 
          </tr>
          <tr bgcolor="#ffffff">
            <td width="25%" align="left">Alamat Rumah</td>
            <td width="5%" align="center">:</td>
            <td width="70%" align="left">'.$row->alamat_lmr.'</td>  
          </tr>
          <tr bgcolor="#ffffff">
